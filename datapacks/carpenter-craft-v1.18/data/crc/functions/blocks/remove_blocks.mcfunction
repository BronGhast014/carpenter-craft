...
execute at @s[tag=CRC_oakLamp2] run loot spawn ~ ~ ~ loot crc:items/oak_sea_lamp
...
execute at @s[tag=CRC_birchLamp2] run loot spawn ~ ~ ~ loot crc:items/birch_sea_lamp
...
execute at @s[tag=CRC_spruceLamp2] run loot spawn ~ ~ ~ loot crc:items/spruce_sea_lamp
...
execute at @s[tag=CRC_darkOakLamp2] run loot spawn ~ ~ ~ loot crc:items/dark_oak_sea_lamp
...
execute at @s[tag=CRC_acaciaLamp2] run loot spawn ~ ~ ~ loot crc:items/acacia_sea_lamp
...
execute at @s[tag=CRC_jungleLamp2] run loot spawn ~ ~ ~ loot crc:items/jungle_sea_lamp
...
execute at @s[tag=CRC_warpedLamp2] run loot spawn ~ ~ ~ loot crc:items/warped_sea_lamp
...
execute at @s[tag=CRC_crimsonLamp2] run loot spawn ~ ~ ~ loot crc:items/crimson_sea_lamp
