...
execute as @s[scores={CRC_tableUsed=22,CRC_tableItem=6}] at @s if block ~ ~ ~ barrel{Items:[{Slot:10b,id:"minecraft:warped_stem",Count:1b}]} run function crc:crafting/table/empty_1
