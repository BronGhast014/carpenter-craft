...
execute as @s[scores={CRC_tableUsed=4,CRC_tableItem=6}] at @s if block ~ ~ ~ barrel{Items:[{Slot:10b,id:"minecraft:dark_oak_log",Count:1b}]} run function crc:crafting/table/empty
