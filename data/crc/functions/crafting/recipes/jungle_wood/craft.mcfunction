...
execute as @s[scores={CRC_tableUsed=6,CRC_tableItem=6}] at @s if block ~ ~ ~ barrel{Items:[{Slot:10b,id:"minecraft:jungle_log",Count:1b}]} run function crc:crafting/table/empty
