...
execute as @s run function give:carpenter_craft/cabnets/birch_cabnet
execute as @s run function give:carpenter_craft/cabnets/spruce_cabnet
execute as @s run function give:carpenter_craft/cabnets/dark_oak_cabnet
